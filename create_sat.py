...
iss = Satellite(satName="ISS", 
                ...
                state_vector=[-3803.111683270652,5637.422077446301,0.651103754965438,-3.940598689126699,-2.661915521602177,5.99985773278453])

debris = Satellite(satName="debris", 
                physical_prop=dict(DryMass=2.00,DragArea=1.1,Cr=0,Cd=2.00,SRPArea=0.00),
                state_vector=[-4500.111683270652,6000.422077446301,8.651103754965438,-3.940598689126699,-1.661915521602177,5.99985773278453])
debris2 = Satellite(satName="debris2", 
                physical_prop=dict(DryMass=8.00,DragArea=1.1,Cr=0,Cd=2.00,SRPArea=0.00),
                state_vector=[-5000.111683270652,6200,5.651103754965438,-4.940598689126699,-2.661915521602177,5.99985773278453])
